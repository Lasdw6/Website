...
const Navbar: React.FC = () => {
  return (
    <nav className="bg-minimal-black fixed w-full top-0 z-50 border-b border-minimal-grey-darker/50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-16">
          <Link
            to="/"
            className="text-xl font-medium text-minimal-grey hover:text-minimal-red transition-colors"
          >
            Vividh Mahajan
          </Link>
